...
try {
  const warehouse = await $api(`/admin/warehouses/${id}`)
  form.external_id = warehouse.external_id || ''
    ...
    <template v-else>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <h1 class="text-[15px] font-semibold text-[#1A1A1A]">Редактировать склад</h1>
        </div>
      </div>

  ...
  <div class="space-y-4 sm:space-y-5">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <h1 class="text-[15px] font-semibold text-[#1A1A1A]">Новая статья</h1>
      </div>
    </div>

    <!-- Form -->
    <div class="bg-white border border-[#E8E6E0] rounded-xl overflow-hidden w-full max-w-4xl">
      ...
      <div class="px-4 sm:px-5 py-4 border-b border-[#F0EEE9]">
        ...
        <div v-if="bannerPreview" class="relative w-full rounded-lg overflow-hidden bg-[#F0EEE9] mb-2" style="aspect-ratio:2/1">
